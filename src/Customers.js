...
class Customers extends Component {
  ...
  addCustomer = () => {
    console.log("added customer", this.state.addCustomer);
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Table
          striped
          className={this.state.addCustomer ? "displayNone" : "customers"}
        >
          <thead>
            <tr>
              <th>#</th>
        ...
        <div
          className={this.state.addCustomer ? "displayBlock" : "displayNone"}
        >
          <AddCustomer addCustomer={this.props.addCustomer} />
        </div>
        <Button onClick={this.addCustomer} color='primary'>
          {this.state.addCustomer ? "Go back" : "Add new customer"}
        </Button>
      </div>
    );
  }
